...
def score_match(win_row: dict[str, Any], goals_row: dict[str, Any] | None) -> dict[str, Any]:
    ...
    over_2_5_odds = to_pct(goals_row.get("over_2_5_odds")) if goals_row else None
    over_3_5_odds = to_pct(goals_row.get("over_3_5_odds")) if goals_row else None
    under_2_5_odds = to_pct(goals_row.get("under_2_5_odds")) if goals_row else None
    under_3_5_odds = to_pct(goals_row.get("under_3_5_odds")) if goals_row else None
    btts_yes_odds = to_pct(goals_row.get("btts_yes_odds")) if goals_row else None
    home_o0_5_odds = to_pct(goals_row.get("home_o0_5_odds")) if goals_row else None
    away_o0_5_odds = to_pct(goals_row.get("away_o0_5_odds")) if goals_row else None
    home_o1_5_odds = to_pct(goals_row.get("home_o1_5_odds")) if goals_row else None
    away_o1_5_odds = to_pct(goals_row.get("away_o1_5_odds")) if goals_row else None
    dc_home_draw_odds = to_pct(
        goals_row.get("dc_home_draw_odds") or win_row.get("dc_home_draw_odds")
    ) if goals_row or win_row else None
    dc_draw_away_odds = to_pct(
        goals_row.get("dc_draw_away_odds") or win_row.get("dc_draw_away_odds")
    ) if goals_row or win_row else None
